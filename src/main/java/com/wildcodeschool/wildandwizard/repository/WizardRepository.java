...
/*** @Repository ==> préciser à WizardRepository qu'il peut être injecté par Spring 
 * L'interface WizardDao ne possède qu'une seule implémentation: WizardRepository, ci dessous :****/
@Repository // <<====>> RELIÉ A @Autowired
