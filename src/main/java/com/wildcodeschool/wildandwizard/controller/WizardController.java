...
public class WizardController {
    ...
    //private WizardDao repository = new WizardDao(); // erreur, on implémente pas une interface
    @Autowired // demande à Spring de créer une instance de WizardRepository, UNIQUE implémentation de l'interface WizardDao
